...
//
//    private ConcurrentMap<Class<?>, CopyOnWriteArraySet<ObserverAction>> registeredEventActions;
//
//
...
//        for (Map.Entry<Class<?>, CopyOnWriteArraySet<ObserverAction>> entry : registeredEventActions) {
//            Class<?> eventType = entry.getKey();
//            Collection<ObserverAction> eventActions = entry.getValue();
